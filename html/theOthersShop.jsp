...
<link rel="stylesheet" href="../css/theOthersShop.css">
<title>다른 사람의 상점</title>
</head>
...
<div id="navDiv">
	<nav>
		<div id="profilePhotoDiv">
			...
			<div id="followDiv"><p id="followP">+&nbsp;&nbsp;팔로우</div>
			<script type="text/javascript">
				var fd = document.getElementById('followDiv');
				var fp = document.getElementById('followP');
				let flag = false;
