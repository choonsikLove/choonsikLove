		...
		<table class="pTable">
			...
			<tr id="row2">
				<th><a href="../MerchDetails.jsp">
						<p class="productName" id="productName1">판매한 상품1</p>
					</a>
					<p id="productCost1">1,000,000원</p>
				</th>
				<th><a href="../MerchDetails.jsp">
						<p class="productName" id="productName2">판매한상품2판매한상품2판매한상품2판매한상품2
							판매한상품2판매한상품2판매한상품2판매한상품2판매한상품2판매한상품2판매한상품2판매한상품2
						</p>
					</a>
					<p id="productCost2">1,000,000원</p>
				</th>
				<th><a href="../MerchDetails.jsp">
						<p class="productName" id="productName3">판매한 상품3</p>
					</a>
					<p id="productCost3">1,000,000원</p>
				</th>
				<th><a href="../MerchDetails.jsp">
						<p class="productName" id="productName4">판매한 상품4</p>
					</a>
			...
			<tr id="row4">
				<th><a href="../MerchDetails.jsp">
						<p id="productName5">판매한 상품5</p>
					</a>
					<p id="productCost1">1,000,000원</p>
				</th>
				<th><a href="../MerchDetails.jsp">
						<p id="productName6">판매한 상품6</p>
					</a>
					<p id="productCost2">1,000,000원</p>
				</th>
				<th><a href="../MerchDetails.jsp">
						<p id="productName7">판매한 상품7</p>
					</a>
					<p id="productCost3">1,000,000원</p>
				</th>
				<th><a href="../MerchDetails.jsp">
						<p id="productName8">판매한 상품8</p>
					</a>
					<p id="productCost4">1,000,000원</p>
				</th>
			</tr>
