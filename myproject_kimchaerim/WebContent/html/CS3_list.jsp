...
<div id="mainDiv">
	<main>
		<div id="topLine">
			<p>나의 문의 내역
			<div id="searchDiv">
				<button id="addButton">+ 글 추가</button>
			</div>
			<hr>
			<script type="text/javascript">
				var fButton = document.getElementById("addButton");
		...
		<script type="text/javascript">
			...
			lineCreate(count, "문의1입니다");
			lineCreate(count, "문의2입니다");
			lineCreate(count, "문의3입니다");
